...
- [x] [vi与vim工具的使用](https://github.com/zeanzai/Java-Linux/blob/master/markdown/use-vi-vim.md)
...
- [x] [maven的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-maven.md)
    - [x] [maven配置全局编译器版本](https://github.com/zeanzai/Java-Linux/blob/master/markdown/maven-config-jdk1.8.md)
- [ ] [node的安装]()
...
- [x] [mysql的安装、配置](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-mysql.md)
    ...
    - [x] [mysql的示例配置文件](https://github.com/zeanzai/Java-Linux/blob/master/markdown/mysql-config-file.md)
...
- [x] [nginx的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-nginx.md)
    - [x] [nginx的反向代理](https://github.com/zeanzai/Java-Linux/blob/master/markdown/nginx-upstream.md)
...
- [x] [jenkins的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-jenkins.md)
    - [x] [jenkins简单实用](https://github.com/zeanzai/Java-Linux/blob/master/markdown/jenkins-use.md)
    - [x] [jenkins持续集成java项目](https://github.com/zeanzai/Java-Linux/blob/master/markdown/jenkins-java-project.md)
    - [x] [jenkins持续集成vue项目](https://github.com/zeanzai/Java-Linux/blob/master/markdown/forend-auto-deploy.md)
    - [ ] [自动化部署中maven的配置]()
...
- [x] [git的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-git.md)
- [x] [gitlab的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-gitlab.md)
- [x] [nexus的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-nexus-centos.md)
...
- [x] [图片服务器的搭建](https://github.com/zeanzai/Java-Linux/blob/master/markdown/image-server.md)
- [ ] [zookeeper的安装]()
- [ ] [solr的安装]()
- [ ] [k8s的安装]()
- [ ] [elasticsearch的安装]()
...
- [ ] [文件服务器的安装]()
- [ ] [禅道的安装]()
- [x] [jeklly的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-jekyll.md)
- [x] [golang的安装](https://github.com/zeanzai/Java-Linux/blob/master/markdown/install-golang.md)
- [ ] [YApi的安装]()
